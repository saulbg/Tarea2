...
int main(int argc, char *argv[])
{
	...
	int ages[] = {23, 43, 12, 89, 2}; // Creating arrays //
	char *names[] = {"Alan", "Frank", "Mary", "John", "Lisa"};
	// safely get the size of ages //
	int count = sizeof(ages) / sizeof(int);
	int i = 0;
	// first way using indexing //
	for(i = 0; i < count; i++) // Starting a loop //
	{
	...
	for(i = 0; i < count; i++) // Another loop //
	{
...
/* Extra Credit
Rewrite all the array usage in this program so that it's pointers. Rewrite all the pointer usage so they're arrays.
...
Rewrite this program to use a function for each of the ways you're printing out things. Try to pass pointers to
these functions so they work on the data. Remember you can declare a function to accept a pointer, but just use it like an array.
